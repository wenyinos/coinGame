    ...
    execute: function () {
      ...
      _export("Main", Main = (_dec = ccclass('Main'), _dec2 = property(Camera), _dec3 = property(Camera), _dec(_class = (_class2 = (_class3 = class Main extends Component {
        ...
        createLayers() {
          ...
          const layer2D = (_crd && aa === void 0 ? (_reportPossibleCrUseOfaa({
            error: Error()
          }), aa) : aa).global.layer2D;

          for (var i = 0; i <= 7; i++) {
            /* if layer0 exist, we clone it, otherwise create a new one */
            const node = layer2D[0] ? instantiate(layer2D[0]) : (_crd && aa === void 0 ? (_reportPossibleCrUseOfaa({
              error: Error()
          ...
          const layer3D = (_crd && aa === void 0 ? (_reportPossibleCrUseOfaa({
            error: Error()
          ...
          const cameras = (_crd && aa === void 0 ? (_reportPossibleCrUseOfaa({
            error: Error()
        ...
        startGame() {
          ...
          const cam = this.camera3D.getComponent(_crd && CameraCtrl === void 0 ? (_reportPossibleCrUseOfCameraCtrl({
            error: Error()
        ...
        async loadRes() {
          await (_crd && aa === void 0 ? (_reportPossibleCrUseOfaa({
            error: Error()
...
//# sourceMappingURL=00cded6b3ea630c7add4b7bd0ac5fd5373e806fc.js.map