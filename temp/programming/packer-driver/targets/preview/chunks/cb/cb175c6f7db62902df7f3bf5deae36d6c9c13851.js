    ...
    execute: function () {
      ...
      _export("KeyConfigView", KeyConfigView = (_dec = ccclass('KeyConfigView'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Node), _dec(_class = (_class2 = class KeyConfigView extends (_crd && BaseView === void 0 ? (_reportPossibleCrUseOfBaseView({
        ...
        onEnable() {
          ...
          var actions = (_crd && aa === void 0 ? (_reportPossibleCrUseOfaa({
            error: Error()
          }), aa) : aa).ctrl.getKeys();
          var viewLenth = this._bindingViews.length;

          if (viewLenth < actions.length) {
            for (var i = viewLenth; i < actions.length; i++) {
              var newBindingView = instantiate(this.bindingView);
              newBindingView.parent = this.layout;
              var bindingView = newBindingView.getComponent(_crd && KeyBindingView === void 0 ? (_reportPossibleCrUseOfKeyBindingView({
                error: Error()
          ...
          this._bindingViews.forEach((view, i) => {
            ...
            var config = ctrl.get(action);

            if (config) {
              var keyLabel = (_crd && getComboName === void 0 ? (_reportPossibleCrUseOfgetComboName({
                error: Error()
...
//# sourceMappingURL=cb175c6f7db62902df7f3bf5deae36d6c9c13851.js.map