    ...
    execute: function () {
      ...
      _export("PlayerCtrl", PlayerCtrl = (_dec = ccclass('PlayerControler'), _dec2 = property(SkeletalAnimation), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class PlayerCtrl extends Component {
        ...
        update(dt) {
          ...
          if (dirV != 0 || dirH != 0) {
            var speedMag = speed * dt * ctrl.mag;
            var eulerY = -Math.atan2(dirV, dirH) * rad + this.camera._targetRotation.y;
            var targetRad = eulerY / rad;
...
//# sourceMappingURL=e76691959debf1bd5204b3f5315099431aafc21b.js.map